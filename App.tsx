...
// const adUnitId = __DEV__ ? TestIds.ADAPTIVE_BANNER : 'ca-app-pub-6968109228755506/6403967683';
const interstitial = InterstitialAd.createForAdRequest('ca-app-pub-6968109228755506/4593026711', {
  requestNonPersonalizedAdsOnly: true
});

const rewardedInterstitial = RewardedInterstitialAd.createForAdRequest('ca-app-pub-6968109228755506/7311529714', {
  requestNonPersonalizedAdsOnly: true
});
...
export default function App() {
  ...
  const rollDice = () => {
    ...
    const newNumbers = Array.from({ length: 2 }, () => Math.floor(Math.random() * 6) + 1);
